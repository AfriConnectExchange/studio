    ...
    <div className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden">
      <div className="p-4 md:p-6 text-center bg-gradient-to-r from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10">
        <div className="flex items-center justify-center gap-2 mb-2 md:mb-3">
          ...
          <span className="text-xl md:text-2xl font-bold hidden lg:block">AfriConnect Exchange</span>
        </div>
        <h1 className="text-lg md:text-xl font-semibold mb-1">Join AfriConnect Exchange</h1>
