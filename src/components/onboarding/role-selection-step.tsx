...
const roles = [
  { id: 'buyer', name: 'Buyer', description: 'Find and purchase products from across Africa.', icon: ShoppingBag },
...
export function RoleSelectionStep({ onNext, onBack, onUpdate, currentValue }: RoleSelectionStepProps) {
    ...
    return (
        ...
        <p className="text-muted-foreground mb-8">What brings you to Africonnect? You can change this later.</p>
